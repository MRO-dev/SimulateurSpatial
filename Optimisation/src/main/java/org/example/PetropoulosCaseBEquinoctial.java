...
public class PetropoulosCaseBEquinoctial {
    ...
    public static void main(String[] args) {
        ...
        double a0     = 24.5059e6;
        double e0     = 0.725;
        double i0     = FastMath.toRadians(7.05); // Angle in radians
        double w0     = FastMath.toRadians(10);
        double W0     = FastMath.toRadians(0.1);
        double LV0    = w0 + W0;
        double thrust = 0.35; // (N)
        double mass   = 2000; //(Kg)
        double ISP    = 2000; // (s)
        ...
        LEOPLawBuilder leopLawBuilder =
                new LEOPLawBuilder(orbit_init, orbit_target, thrust, ISP, mass).withThrustEffectivity(0.)
        ...
        ToleranceBuilder.EquinoctialTolerance equinoctialTolerance =
                toleranceBuilder.withFirstParam(1e4).withSecondParam(0.001).withThirdParam(0.001).withFourthParam(0.0001).withFifthParam(0.0001)
