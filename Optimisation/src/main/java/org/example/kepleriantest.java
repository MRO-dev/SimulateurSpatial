...
public class kepleriantest {
    ...
    public static void main(String[] args) {
        ...
        ToleranceBuilder.KeplerianTolerance keplerianTolerance =
                toleranceBuilder.withFirstParam(2e4).withSecondParam(0.05).withFourthParam(0.1).withFifthParam(0.1)
        ...
        for (int i = 0; i < 5; i++) {
            System.out.println(keplerianTolerance.getTolerances()[i]);

        }
        System.out.println(keplerianTolerance.isFirstParameterCriterion());
        System.out.println(keplerianTolerance.isSecondParameterCriterion());
        System.out.println(keplerianTolerance.isThirdParameterCriterion());
        System.out.println(keplerianTolerance.isFourthParameterCriterion());
        System.out.println(keplerianTolerance.isFifthParameterCriterion());
    ...
    private static void addL2EvolutiontoOutput(final StringBuilder dataL2Error,
                                               final KeplerianQLaw.Output Qsolve) {
