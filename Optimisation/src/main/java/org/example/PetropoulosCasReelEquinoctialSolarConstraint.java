...
public class PetropoulosCasReelEquinoctialSolarConstraint {
    ...
    public static void main(String[] args) {
        ...
        LEOPLawBuilder leopLawBuilder =
                new LEOPLawBuilder(orbit_init, orbit_target, thrust, ISP, mass).withThrustEffectivity(0.).withEclipse()
