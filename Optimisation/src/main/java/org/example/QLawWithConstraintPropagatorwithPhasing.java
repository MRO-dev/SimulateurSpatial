...
public class QLawWithConstraintPropagatorwithPhasing {
    ...
    public QLawWithConstraintPropagatorwithPhasing(final Orbit initialOrbit, final Orbit targetOrbit, final double maxThrust,
                                                   final double ISP) {
        this(initialOrbit, targetOrbit, QLawWithConstraintPropagatorwithPhasing::keplerianPropagator, maxThrust, ISP, 1000,
             0., 1, 10e4,
             1000, 1000, 1000, 1000);
    ...
    public QLawWithConstraintPropagatorwithPhasing(final Orbit initialOrbit, final Orbit targetOrbit, final double maxThrust,
        ...
        this(initialOrbit, targetOrbit, QLawWithConstraintPropagatorwithPhasing::keplerianPropagator, maxThrust, ISP,
             massInit, 0., 1,
    ...
    public QLawWithConstraintPropagatorwithPhasing(final Orbit initialOrbit, final Orbit targetOrbit,
    ...
    class Output {
        ...
        public double getL2Error() {
            ...
            return QLawWithConstraintPropagatorwithPhasing.this.getL2Error();
        }
    }
}
